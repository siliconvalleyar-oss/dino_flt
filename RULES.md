# Reglas de Programación — Dino Run
...
- **Entities** (`lib/core/entities/`) para componentes del juego (dino, obstáculos, suelo, nubes).
- **Config** (`lib/core/config/`) para constantes de juego.

## Assets

- **Sprites del Dino**: `assets/images/dino/dino_run_00-03.png` — PNGs animación carrera.
