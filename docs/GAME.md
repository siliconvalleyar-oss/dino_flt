# Dino Run — Game Overview

Chrome Dino-style endless runner built with Flutter & Flame Engine.
...
- White/light gray background (`#F7F7F7`)
- Dark gray dino, obstacles, ground line
- Score displayed top-right
- "TAP TO START" / "GAME OVER" / "TAP TO RESTART" centered
